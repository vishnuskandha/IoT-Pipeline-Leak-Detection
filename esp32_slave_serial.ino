...
void setup() {
  ...
  Serial.println("ESP32 Slave Debug Mode Started");
...
void updateSensors() {
  ...
  // DEBUG PRINT
  // We print every 1 second roughly (tied to flow calc or just added delay)
  static unsigned long lastPrint = 0;
  if (millis() - lastPrint > 1000) {
    Serial.println("----- Sensor Readings -----");
    Serial.print("Analog Turb: ");
    Serial.print(adcTurbX);
    Serial.print(" -> NTU: ");
    Serial.println(ntu);
